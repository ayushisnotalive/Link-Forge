      ...
      <div className="w-full max-w-sm rounded-2xl border border-zinc-900 bg-black p-8 shadow-[0_0_50px_-15px_rgba(0,0,0,0.9)]">
        <form onSubmit={handleSubmit} className="w-full">
          <div className="mb-6 flex items-center gap-2.5">
            ...
            <h1 className="text-lg font-bold tracking-tight text-white">Create an account</h1>
          </div>
          ...
          <p className="mt-5 text-center text-xs text-zinc-500">
            Already have an account? <Link to="/login" className="font-medium text-orange-500 transition-colors hover:text-orange-400">Log in</Link>
          </p>
        </form>
      </div>
    </div>
